...
function enviar($recibido, $enviado, $idWA,$timestamp,$telefonoCliente) {
    ...
    if ($cantidad == 0) {
        ...
        $token = 'EAAJYH3LCfNcBAHFkjtekPjoaqZB6Pp4HQs69nqggZCqaMmcRZAgwurn62G2PpZCxIH1AHyQjLeDWAhRgDY2jRK6LzVzbHIaabuykYGxjSQHQJ3ZBsUC8Q3SnffbUB6q1CZBKz81kpr15jT1397GfIHA32v2GgWZCThqjt1d6hUBoMb1W6c7TW8ZAyaIpMbbPYR4VeqjZA2ZBuYEn7MfMFVyC8j';
        //NUESTRO TELEFONO
        $telefono = '51936001232';
        //IDENTIFICADOR DE NÚMERO DE TELÉFONO
        $telefonoID = '116805471428924';
