...
$dotenv->load();
function enviar($received, $data, $data1, $data2, $data3, $data4, $data5, $des_data, $des_data1, $des_data2, $des_data3, $des_data4, $des_data5, $type, $sent, $idWA,$timestamp,$customer_phone) {
    ...
    if ($quantity == 0) {
        ...
        elseif($type === "button-reply"){
            ...
            . '                     "id": "id-1002",'
            . '                     "title": "' . $data1 .'",'
            . '                     "description": "' . $des_data1 .'" '
            . '},'
            . '{'
            . '                     "id": "id-1003",'
            . '                     "title": "' . $data2 .'",'
            . '                     "description": "' . $des_data2 .'" '
            . '},'
            . '{'
            . '                     "id": "id-1004",'
            . '                     "title": "' . $data3 .'",'
            . '                     "description": "' . $des_data3 .'" '
            . '},'
            . '{'
            . '                     "id": "id-1005",'
            . '                     "title": "'. $data4 .'",'
            . '                     "description": "' . $des_data4 .'" '
            . '}'
            . '],'
            . '},'
            . ']'
